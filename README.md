...
This is the free, open-source build of Postern. For the VPS-hosted
build with VPN kill-switch, trusted-device sign-in, unlimited mailboxes
and send-later, see the paid product at [billing.postern.email](https://billing.postern.email).

📖 **Full documentation: [docs.postern.email](https://docs.postern.email)**
— install walkthroughs, configuration reference, mailbox-provider
guides (Gmail app passwords, etc.), and storage invariants.
...
Full docs are at [docs.postern.email](https://docs.postern.email):
...
- [Guides](https://docs.postern.email/guides/) — provider setup
  walkthroughs (Gmail app passwords, etc.)
- [Reference](https://docs.postern.email/reference/) — storage
  invariants, migration notes
