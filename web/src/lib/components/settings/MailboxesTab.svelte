<script lang="ts">
  ...
  import { ACCOUNT_COLOR_PALETTE, colorForAccount } from '$lib/accountColor';
                  ...
                  <div class="color-row">
                    ...
                    <div class="color-swatches">
                      {#each ACCOUNT_COLOR_PALETTE as swatch (swatch)}
                        <button
                          type="button"
                          class="swatch"
                          class:active={d.color.toLowerCase() === swatch}
                          style:background-color={swatch}
                          aria-label={`Use ${swatch}`}
                          onclick={() => updateMailboxDraft(a.id, { color: swatch })}
                        ></button>
                      {/each}
                    </div>
                    <input
                      ...
                      type="color"
                      class="color-input"
                      value={d.color || colorForAccount(a)}
                    ...
                    {#if d.color}
                      <button
                        type="button"
                        class="btn small"
                        onclick={() => updateMailboxDraft(a.id, { color: '' })}
