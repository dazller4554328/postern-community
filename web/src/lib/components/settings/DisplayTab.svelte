<script lang="ts">
  ...
  // Curated CSS font-stacks — no downloads, each picks the best
  // available installed font on the user's OS. Order: defaults
  // first, then sans variants, then serifs, then specials.
  const FONTS: FontId[] = [
    'system',
    'humanist',
    'geometric',
