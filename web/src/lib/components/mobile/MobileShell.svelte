<script lang="ts">
  ...
  function selectView(
    target: 'unified' | 'reminders' | 'calendar' | 'outbox' | 'contacts'
  ) {
    closeSearch();
    if (target === 'unified') {
      accountId = null;
...
<div class="mobile-app">
  ...
  {:else if mode === 'inbox'}
    ...
    {:else}
      <!-- Brand bar — Postern wordmark on the left, action icons
           on the right (search / refresh / lock). Telegram-style. -->
      <header class="brand-bar">
        <a href="/inbox" class="brand-link" aria-label="Postern home">
          <img src="/logo-light.png" alt="Postern" class="brand-logo brand-logo-light" />
          <img src="/logo-dark.png" alt="" class="brand-logo brand-logo-dark" aria-hidden="true" />
          <img src="/logo-cyberpunk.png" alt="" class="brand-logo brand-logo-cyberpunk" aria-hidden="true" />
        </a>
...
<style>
  ...
  /* Brand bar — Telegram-style top row. Postern wordmark on the
  ...
  .brand-logo-dark, .brand-logo-cyberpunk { display: none; }
  /* Theme-aware logo swap — same pattern VaultGate uses so brand
     adapts to whatever theme the user has set. */
  :global([data-theme='dark']) .brand-logo-light,
  :global([data-theme='solarized-dark']) .brand-logo-light,
  :global([data-theme='dracula']) .brand-logo-light,
  :global([data-theme='nord']) .brand-logo-light,
  :global([data-theme='gruvbox']) .brand-logo-light,
  :global([data-theme='monokai']) .brand-logo-light,
  :global([data-theme='forest']) .brand-logo-light,
  :global([data-theme='rose-pine']) .brand-logo-light,
  :global([data-theme='acid-rain']) .brand-logo-light,
  :global([data-theme='volcanic']) .brand-logo-light,
  :global([data-theme='abyssal']) .brand-logo-light,
  :global([data-theme='arcade']) .brand-logo-light { display: none; }
  :global([data-theme='dark']) .brand-logo-dark,
  :global([data-theme='solarized-dark']) .brand-logo-dark,
  :global([data-theme='dracula']) .brand-logo-dark,
  :global([data-theme='nord']) .brand-logo-dark,
  :global([data-theme='gruvbox']) .brand-logo-dark,
  :global([data-theme='monokai']) .brand-logo-dark,
  :global([data-theme='forest']) .brand-logo-dark,
  :global([data-theme='rose-pine']) .brand-logo-dark,
  :global([data-theme='acid-rain']) .brand-logo-dark,
  :global([data-theme='volcanic']) .brand-logo-dark,
  :global([data-theme='abyssal']) .brand-logo-dark,
  :global([data-theme='arcade']) .brand-logo-dark { display: block; }
  :global([data-theme='cyberpunk']) .brand-logo-light { display: none; }
  :global([data-theme='cyberpunk']) .brand-logo-cyberpunk { display: block; }
  @media (prefers-color-scheme: dark) {
    :global(html:not([data-theme])) .brand-logo-light { display: none; }
    :global(html:not([data-theme])) .brand-logo-dark { display: block; }
  }
  .brand-actions {
    display: inline-flex;
    align-items: center;
