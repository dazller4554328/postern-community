...
<style>
  ...
  /* Back is the primary nav affordance on this screen — pair the larger
     chevron with a label and a pill so it reads clearly and is easy to
     hit, rather than a lone small glyph. */
  .back-btn {
