...
/** B / KB / MB rounded for human display. Single-source so the
 *  attachments tray and forensics pane render the same numbers. */
...
/** ISO 3166-1 alpha-2 → regional-indicator flag emoji. Returns ''
 *  when the input isn't a 2-letter code. */
